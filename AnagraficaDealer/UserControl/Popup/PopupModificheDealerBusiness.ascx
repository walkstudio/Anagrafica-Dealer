<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PopupModificheDealerBusiness.ascx.cs" Inherits="Spindox.AnagraficaDealer.UserControl.Popup.PopupModificheDealerBusiness" %>
    ...
    <ContentTemplate>
        <table class="popupMessaggioBig">
            ...
            <tr class="trFooterPopupMessaggio">
                <td colspan="2">
                    <asp:ImageButton ID="btnModifica" CssClass="imgBtn" runat="server" OnClick="btnModifica_Click" ImageUrl="~/Resources/Images/Bottoni/btn_confirm_popup.png" ValidationGroup="btnConferma" />
