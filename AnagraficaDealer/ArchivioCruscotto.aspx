<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ArchivioCruscotto.aspx.cs" Inherits="Spindox.AnagraficaDealer.ArchivioCruscotto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeaderContentPlaceHolder" runat="server">
    <script type="text/javascript">
        window.onload = function selectMenuTab() {
            ...
            document.getElementById('MainContentPlaceHolder_ArchivioSubMenuControl_archivioCruscottoSubMenu').className = "divSubMenuSelectedTab";
            document.getElementById('archivioCruscottoLabel').className = "labelSubMenuSelected";
        }
        ...
        function gridviewScroll() {
            $('#<%=archivioCruscottoGridView.ClientID%>').gridviewScroll({
                width: "99.99%",
                height: 470,
                freezesize: 0,
                arrowsize: 30,
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    ...
    <asp:UpdatePanel ID="ACUpdatePanel" runat="server" UpdateMode="Conditional">
                ...
                <tr>
                    <td>
                        ...
                        <div id="divGridView" class="divGridViewImport">
                            <asp:GridView ID="archivioCruscottoGridView" runat="server" AutoGenerateColumns="False" GridLines="None" Width="100%" OnRowDataBound="archivioCruscottoGridView_RowDataBound" OnDataBound="archivioCruscottoGridView_DataBound">
                                <Columns>
                                    <asp:TemplateField HeaderText="DataExport" SortExpression="DataExport">
                                        <ItemTemplate>
                                            <asp:Label ID="lblDataAC" runat="server" Text='<%# Eval("DataExport","{0:dd/MM/yyyy HH:mm:ss}") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
