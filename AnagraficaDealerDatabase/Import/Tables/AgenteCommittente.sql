CREATE TABLE [Import].[AgenteCommittente] (
    [IDAgenteCommittente]   INT           IDENTITY (1, 1) NOT NULL,
    [IDArea]                INT           NULL,
    ...
    [IDDealer]              INT           NULL,
    CONSTRAINT [PK_AgenteCommittente] PRIMARY KEY CLUSTERED ([IDAgenteCommittente] ASC)
);
