CREATE PROCEDURE [Import].[SP_ImportSubAgenti] 
AS
BEGIN
	SET NOCOUNT ON;
	...
	BEGIN TRANSACTION
		...
		BEGIN TRY 
			...
			SELECT SA.Indirizzo, SA.PIVA, SA.Telefono, SA.Fax, @ChangeDate, @SystemUserID, @IDTipoDealer, SA.IDStato, SA.Codice, SA.Funzione
			...
			INSERT INTO InfoGenerali.InfoSubAgenti ( IDDealer, BOL, DataAperturaCodice, DataChiusuraCodice )
	...
	BEGIN TRANSACTION
		...
		BEGIN TRY 
			...
			SET Dealer.Dealer.Indirizzo = SA.Indirizzo,
					...
					Dealer.Dealer.Funz = SA.Funzione
			FROM Import.SubAgente SA
			...
			SET InfoGenerali.InfoSubAgenti.BOL = SA.BOL,
					InfoGenerali.InfoSubAgenti.DataAperturaCodice = SA.DataAttivazione,
					InfoGenerali.InfoSubAgenti.DataChiusuraCodice = SA.DataDisattivazione
			FROM Import.SubAgente SA
